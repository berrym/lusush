 ...
 * 
 * Provides Unicode-normalized string comparison using NFC (Canonical Composition)
 * normalization. This ensures that equivalent Unicode sequences compare as equal
