...
echo "  To test: Type '$TEST_CHAR' in lush, press backspace"
echo ""
...
echo "  To test: Type '$TEST_CHAR' in lush, check cursor position"
echo ""
...
echo "  To test: Type '$TEST_STR' in lush, check cursor shows position 8"
echo ""
