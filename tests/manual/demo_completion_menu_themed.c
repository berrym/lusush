...
static completion_result_t* create_demo_completions(void) {
    ...
    completion_result_add(result, "config.json", " ", COMPLETION_TYPE_FILE, 600);
    ...
    // Add history
    completion_result_add(result, "git commit -m", " ", COMPLETION_TYPE_HISTORY, 400);
    completion_result_add(result, "make clean", " ", COMPLETION_TYPE_HISTORY, 400);
...
int main(void) {
    printf("\n");
    printf("╔════════════════════════════════════════════════════════════════╗\n");
    printf("║  Completion Menu - Theme Integration Demo                     ║\n");
    printf("╚════════════════════════════════════════════════════════════════╝\n");
    printf("\n");
    ...
    char header[256];
    completion_menu_format_header_themed(COMPLETION_TYPE_BUILTIN, 5, 
                                        header, sizeof(header));
    printf("Header example: %s\n\n", header);
    
    // Test item formatting
    completion_item_t test_item = {
    ...
    char item_line[512];
    completion_menu_format_item_themed(&test_item, false, item_line, sizeof(item_line));
    printf("Item (normal):   %s\n", item_line);
    
    completion_menu_format_item_themed(&test_item, true, item_line, sizeof(item_line));
