 ...
 * 
 * Usage:
 *   1. Compile and run: make -C tests/lle/manual test_fkey_manual && tests/lle/manual/test_fkey_manual
...
static const char* key_to_string(lle_special_key_t key) {
    switch (key) {
        case LLE_KEY_F1: return "F1";
        case LLE_KEY_F2: return "F2";
        case LLE_KEY_F3: return "F3";
        case LLE_KEY_F4: return "F4";
        case LLE_KEY_F5: return "F5";
        case LLE_KEY_F6: return "F6";
        case LLE_KEY_F7: return "F7";
        case LLE_KEY_F8: return "F8";
        case LLE_KEY_F9: return "F9";
        case LLE_KEY_F10: return "F10";
        case LLE_KEY_F11: return "F11";
        case LLE_KEY_F12: return "F12";
        case LLE_KEY_UP: return "UP";
        case LLE_KEY_DOWN: return "DOWN";
        case LLE_KEY_LEFT: return "LEFT";
        case LLE_KEY_RIGHT: return "RIGHT";
        ...
        case LLE_KEY_INSERT: return "INSERT";
        ...
        switch (event.type) {
            ...
            case LLE_INPUT_TYPE_SPECIAL_KEY:
                ...
                if (event.data.special_key.modifiers) {
                    printf(" (");
                    if (event.data.special_key.modifiers & LLE_MOD_SHIFT) printf("Shift+");
                    if (event.data.special_key.modifiers & LLE_MOD_ALT) printf("Alt+");
                    if (event.data.special_key.modifiers & LLE_MOD_CTRL) printf("Ctrl+");
                    if (event.data.special_key.modifiers & LLE_MOD_META) printf("Meta+");
