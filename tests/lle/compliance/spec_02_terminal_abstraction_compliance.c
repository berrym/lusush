...
void test_terminal_capabilities_structure(void) {
    ...
    TEST_ASSERT(caps.supports_ansi_colors == true, "supports_ansi_colors field accessible");
...
void test_internal_state_structure(void) {
    ...
    TEST_ASSERT(state.buffer_modified == false, "buffer_modified field accessible");
...
void test_display_content_structure(void) {
    ...
    TEST_ASSERT(content.cursor_visible == true, "cursor_visible field accessible");
...
void test_input_event_structure(void) {
    ...
    TEST_ASSERT(event.type == LLE_INPUT_TYPE_CHARACTER, "type field accessible");
...
void test_enum_definitions(void) {
    ...
    TEST_ASSERT(input_type == LLE_INPUT_TYPE_CHARACTER, "lle_input_type_t enum defined");
