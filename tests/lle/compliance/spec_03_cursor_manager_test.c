...
static void test_cursor_position_structure() {
    ...
    ASSERT_TRUE(sizeof(pos.codepoint_index) > 0, "codepoint_index field exists");
...
static void test_cursor_manager_init() {
    ...
    ASSERT_TRUE(sizeof(lle_cursor_manager_t) > 0, "Cursor manager structure defined");
    ASSERT_TRUE(sizeof(lle_cursor_position_t) > 0, "Cursor position structure defined");
