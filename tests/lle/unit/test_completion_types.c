...
static void test_type_info_queries(void) {
    ...
    const char *category = lle_completion_type_get_category(LLE_COMPLETION_TYPE_COMMAND);
    assert(strcmp(category, "COMMANDS") == 0);
    
    // Test indicator getter
    const char *indicator = lle_completion_type_get_indicator(LLE_COMPLETION_TYPE_FILE);
...
static void test_completion_item_lifecycle(void) {
    ...
    // Note: LLE uses global memory pool, so we pass a dummy non-NULL pool pointer
...
static void test_completion_result_lifecycle(void) {
    ...
    // Test item retrieval
    const lle_completion_item_t *item = lle_completion_result_get_item(result, 0);
    assert(item != NULL);
...
static void test_completion_result_sorting(void) {
    ...
    lle_completion_result_add(result, "file1.txt", "", 
                             LLE_COMPLETION_TYPE_FILE, 500);
    lle_completion_result_add(result, "cd", " ",
                             LLE_COMPLETION_TYPE_BUILTIN, 950);
    lle_completion_result_add(result, "ls", " ",
                             LLE_COMPLETION_TYPE_COMMAND, 800);
    lle_completion_result_add(result, "echo", " ",
                             LLE_COMPLETION_TYPE_BUILTIN, 900);
    ...
    const lle_completion_item_t *item0 = lle_completion_result_get_item(result, 0);
    const lle_completion_item_t *item1 = lle_completion_result_get_item(result, 1);
    const lle_completion_item_t *item2 = lle_completion_result_get_item(result, 2);
    const lle_completion_item_t *item3 = lle_completion_result_get_item(result, 3);
...
static void test_error_handling(void) {
    ...
    result = lle_completion_item_create(
        pool, "test", " ", LLE_COMPLETION_TYPE_COMMAND, 800, NULL);
    assert(result == LLE_ERROR_INVALID_PARAMETER);
