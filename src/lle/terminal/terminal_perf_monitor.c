 ...
 */
void lle_terminal_monitor_display_generation(lle_performance_monitor_t *perf_monitor,
    ...
    uint64_t per_line_time_us = line_count > 0 ? generation_time_us / line_count : 0;
 ...
 */
void lle_terminal_monitor_input_processing(lle_performance_monitor_t *perf_monitor,
 ...
 */
lle_result_t lle_terminal_get_performance_stats(lle_performance_monitor_t *perf_monitor,
                                               uint64_t *avg_display_time_us,
                                               uint64_t *avg_input_time_us,
                                               size_t *total_operations) {
    if (!perf_monitor || !avg_display_time_us || !avg_input_time_us || !total_operations) {
