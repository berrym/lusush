...
extern lle_result_t lle_initialize_display_client_controller(
    lle_adaptive_context_t *context,
    lusush_memory_pool_t *memory_pool);
extern lle_result_t lle_initialize_multiplexer_controller(
    lle_adaptive_context_t *context,
    lusush_memory_pool_t *memory_pool);
extern lle_result_t lle_initialize_minimal_controller(
    lle_adaptive_context_t *context,
    lusush_memory_pool_t *memory_pool);

extern void lle_cleanup_native_controller(lle_native_controller_t *native);
extern void lle_cleanup_display_client_controller(lle_display_client_controller_t *client);
extern void lle_cleanup_multiplexer_controller(lle_multiplexer_controller_t *mux);
...
extern lle_result_t lle_display_client_read_line(lle_display_client_controller_t *client,
                                                 const char *prompt, char **line);
 ...
 */
static lle_result_t lle_adaptive_interface_read_line(
    lle_adaptive_context_t *ctx,
    const char *prompt,
    char **line) {
    ...
    switch (ctx->mode) {
        ...
        case LLE_ADAPTIVE_MODE_ENHANCED:
            return lle_display_client_read_line(ctx->controller.display_client, prompt, line);
 ...
 */
static lle_result_t lle_adaptive_interface_process_input(
    lle_adaptive_context_t *ctx,
    const char *input,
    size_t length,
    void **events) {
 ...
 */
static lle_result_t lle_adaptive_interface_update_display(
    lle_adaptive_context_t *ctx) {
 ...
 */
static lle_result_t lle_adaptive_interface_handle_resize(
    lle_adaptive_context_t *ctx,
    int new_width,
    int new_height) {
 ...
 */
static lle_result_t lle_adaptive_interface_set_configuration(
    lle_adaptive_context_t *ctx,
    void *config) {
 ...
 */
static lle_result_t lle_adaptive_interface_get_status(
    lle_adaptive_context_t *ctx,
    void *status) {
 ...
 */
static void lle_assign_interface_functions(lle_adaptive_interface_t *interface) {
...
lle_result_t lle_initialize_adaptive_context(
    ...
    memcpy(ctx->detection_result, detection_result, sizeof(lle_terminal_detection_result_t));
    ...
    if (ctx->mode < LLE_ADAPTIVE_MODE_NONE || ctx->mode > LLE_ADAPTIVE_MODE_MULTIPLEXED) {
        free(ctx->detection_result);
        free(ctx);
        return LLE_ERROR_INVALID_STATE;
    }
...
void lle_adaptive_get_recommended_config(
    ...
    config->enable_lle = (detection->recommended_mode != LLE_ADAPTIVE_MODE_NONE);
