...
lle_result_t lle_widget_hooks_manager_init(lle_widget_hooks_manager_t **manager,
    ...
    lle_widget_hooks_manager_t *mgr = lle_pool_alloc(sizeof(lle_widget_hooks_manager_t));
    if (!mgr) {
...
lle_result_t lle_widget_hooks_manager_destroy(lle_widget_hooks_manager_t *manager) {
    if (!manager) {
        return LLE_ERROR_INVALID_PARAMETER;
    }
...
lle_result_t lle_widget_hook_register(lle_widget_hooks_manager_t *manager,
    ...
    lle_hook_registration_t *reg = lle_pool_alloc(sizeof(lle_hook_registration_t));
    if (!reg) {
        return LLE_ERROR_OUT_OF_MEMORY;
    }
