    ...
    lle_completion_result_t **result)
{
    ...
    lle_completion_result_t *new_result = 
        (lle_completion_result_t*)lle_pool_alloc(sizeof(lle_completion_result_t));
    if (!new_result) {
        return LLE_ERROR_OUT_OF_MEMORY;
    }
    ...
    new_result->items = 
        (lle_completion_item_t*)lle_pool_alloc(sizeof(lle_completion_item_t) * initial_capacity);
    if (!new_result->items) {
    ...
    lle_completion_item_t *item)
{
    ...
    if (result->count >= result->capacity) {
        ...
        lle_completion_item_t *new_items = 
            (lle_completion_item_t*)lle_pool_alloc(sizeof(lle_completion_item_t) * new_capacity);
        if (!new_items) {
            return LLE_ERROR_OUT_OF_MEMORY;
        }
